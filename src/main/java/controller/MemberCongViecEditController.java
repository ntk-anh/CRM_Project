...
@WebServlet("/member-congviec-edit")
public class MemberCongViecEditController extends HttpServlet{
	...
	public MemberCongViecEditController() {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.getRequestDispatcher("./views/member/congviec/congviec-edit.jsp").forward(req, resp);
	}
	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//thông báo
		if (result>0) {
			resp.sendRedirect(req.getContextPath()+"/member-congviec-list?result=updateSuccess");
		}else {
			resp.sendRedirect(req.getContextPath()+"/member-congviec-list?result=updateError");
		}
	}
}
