...
@WebServlet("/admin-congviec-edit")
public class AdminCongViecEditController extends HttpServlet{
	...
	public AdminCongViecEditController() {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.getRequestDispatcher("./views/congviec/congviec-edit.jsp").forward(req, resp);
	}
	@Override
