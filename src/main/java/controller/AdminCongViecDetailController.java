...
@WebServlet("/admin-congviec-detail")
public class AdminCongViecDetailController extends HttpServlet {
	...
	public AdminCongViecDetailController() {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		/*cách này thất bại rồi
		ArrayList<CongViec> congViecs = congViecDAO.getByDuAnId(id_duAn);
		ArrayList<Integer> userIds = congViecDAO.getUserIdByDuAnId(id_duAn);
		
		req.setAttribute("userIds", userIds);
		req.setAttribute("congViecs", congViecs);
		*/
