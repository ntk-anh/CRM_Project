		...
		<nav class="navbar navbar-default navbar-static-top m-b-0 ">
			<div class="navbar-header">
				...
				<div class="top-left-part">
					<a class="logo" href="<%= request.getContextPath() %>/admin-user-list"> <b> <img
