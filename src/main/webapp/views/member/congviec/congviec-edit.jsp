			...
			<div class="col-md-8 col-xs-12">
				<div class="white-box">
					...
					<form class="form-horizontal form-material"
						action="<%=request.getContextPath()%>/member-congviec-edit" method="post">
						...
						<div class="form-group hidden">
							<label class="col-md-12">Id</label>
							<div class="col-md-12">
								<input type="text" id="id" name="id_user" value="<%=congViec.getIdUser()%>"
									class="form-control form-control-line">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-12">
								<input type="hidden" id="ten_cong_viec" name="ten_cong_viec" value="<%=congViec.getTenCongViec()%>" />
								<select  disabled class="form-control form-control-line">
									<option value="<%=congViec.getTenCongViec()%>"><%=congViec.getTenCongViec()%></option>
								</select>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-12">
								<input type="hidden" id="nguoi_thuc_hien" name="nguoi_thuc_hien" value="<%=congViec.getTenUser()%>" />
								<select  disabled class="form-control form-control-line">
									<option value="<%=congViec.getTenUser()%>"><%=congViec.getTenUser()%></option>
								</select>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<div class="col-sm-12">
								...
								<a href="<%=request.getContextPath()%>/member-congviec-list"
